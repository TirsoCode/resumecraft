    ...
    <div style={{ fontFamily: "var(--font-dm), system-ui", color: "#1A1918", background: "#FAFAFA", padding: p3644 }}>
      ...
      {data.settings.sections.experience && experience.length > 0 && <section style={{ marginBottom: p24 }}>
        ...
        {experience.map((item) => <div key={item.id} style={{ marginBottom: p16 }}>
          <div style={{ display: "flex", justifyContent: "space-between" }}><h3 style={{ fontSize: 13*s, fontWeight: 700, margin: 0 }}>{item.position}</h3><span style={{ fontSize: 10*s, fontFamily: "var(--font-jetbrains), monospace", color: "#9C9890" }}>{item.startDate} — {item.endDate}</span></div>
      ...
      {data.settings.sections.education && education.length > 0 && <section style={{ marginBottom: p24 }}>
        ...
        {education.map((item) => <div key={item.id} style={{ marginBottom: p10 }}><div style={{ display: "flex", justifyContent: "space-between" }}><h3 style={{ fontSize: 12*s, fontWeight: 700, margin: 0 }}>{item.degree}</h3><span style={{ fontSize: 10*s, fontFamily: "var(--font-jetbrains), monospace", color: "#9C9890" }}>{item.startDate} — {item.endDate}</span></div><p style={{ fontSize: 11*s, color: "#6B6860", margin: p20_0_0 }}>{item.institution}</p></div>)}
      </section>}
      {data.settings.sections.certifications && certifications.length > 0 && <section style={{ marginBottom: p24 }}>
        ...
        {certifications.map((item) => <div key={item.id} style={{ marginBottom: p10 }}><div style={{ display: "flex", justifyContent: "space-between" }}><h3 style={{ fontSize: 12*s, fontWeight: 700, margin: 0 }}>{item.name}</h3><span style={{ fontSize: 10*s, fontFamily: "var(--font-jetbrains), monospace", color: "#9C9890" }}>{item.date}</span></div><p style={{ fontSize: 11*s, color: "#6B6860", margin: p20_0_0 }}>{item.issuer}</p></div>)}
      </section>}
      ...
      {data.settings.sections.licenses && licenses.length > 0 && <section style={{ marginBottom: p24 }}>
        ...
        {licenses.map((item) => <div key={item.id} style={{ marginBottom: p10 }}><div style={{ display: "flex", justifyContent: "space-between" }}><h3 style={{ fontSize: 12*s, fontWeight: 700, margin: 0 }}>{item.name}</h3><span style={{ fontSize: 10*s, fontFamily: "var(--font-jetbrains), monospace", color: "#9C9890" }}>{item.date}</span></div><p style={{ fontSize: 11*s, color: "#6B6860", margin: p20_0_0 }}>{item.issuer}{item.licenseNumber && ` • ${item.licenseNumber}`}</p></div>)}
      </section>}
      {data.settings.sections.references && references.length > 0 && <section style={{ marginBottom: p24 }}>
        ...
        {references.map((item) => <div key={item.id} style={{ marginBottom: p10 }}><h3 style={{ fontSize: 12*s, fontWeight: 700, margin: 0 }}>{item.name}</h3><p style={{ fontSize: 11*s, color: "#6B6860", margin: p20_0_4 }}>{item.company}{item.relationship && ` • ${item.relationship}`}</p><p style={{ fontSize: 10*s, color: "#9C9890", margin: p20_0_0 }}>{item.email}{item.phone && ` • ${item.phone}`}</p></div>)}
      </section>}
      {data.settings.sections.affiliations && affiliations.length > 0 && <section style={{ marginBottom: p24 }}>
        ...
        {affiliations.map((item) => <div key={item.id} style={{ marginBottom: p10 }}><div style={{ display: "flex", justifyContent: "space-between" }}><h3 style={{ fontSize: 12*s, fontWeight: 700, margin: 0 }}>{item.organization}</h3><span style={{ fontSize: 10*s, fontFamily: "var(--font-jetbrains), monospace", color: "#9C9890" }}>{item.startDate}{item.endDate && ` — ${item.endDate}`}</span></div><p style={{ fontSize: 11*s, color: "#6B6860", margin: p20_0_0 }}>{item.role}</p></div>)}
      </section>}
