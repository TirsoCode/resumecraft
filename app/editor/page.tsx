      ...
      <main style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", padding: "32px 24px", overflowY: "auto" }}>
        <div style={{ display: "flex", gap: 10, marginBottom: 24, width: "100%", maxWidth: 720, justifyContent: "space-between", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button onClick={handleExportMd} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 16px", background: "#fff", color: "#1A1918", border: "1px solid #E4E2DC", borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: "pointer", fontFamily: "'Instrument Sans', sans-serif" }}>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14,2 14,8 20,8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10,9 9,9 8,9"/>
              </svg>
              Exportar MD
            </button>
            <button onClick={handleExportPDF} disabled={isExporting} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "8px 16px", background: "#1A1918", color: "#fff", border: "none", borderRadius: 8, fontSize: 12, fontWeight: 600, cursor: isExporting ? "wait" : "pointer", opacity: isExporting ? 0.7 : 1, fontFamily: "'Instrument Sans', sans-serif" }}>
              {isExporting ? (
                <>
